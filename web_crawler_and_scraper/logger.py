...
def open_log_files():
    ...
    rejected_log = open("./web_crawler_and_scraper/logs/rejected_links.log", "w", encoding="utf-8")  # Open in append mode
    crawled_log = open("./web_crawler_and_scraper/logs/crawled_links.log", "w", encoding="utf-8")    # Open in append mode
